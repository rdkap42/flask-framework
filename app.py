...
def stockresults():
    ...
    if 'adjopeningprice' in request.form:
        p.line(data_lastmonth['Date'], data_lastmonth['Adj. Open'], line_color='blue', line_dash=[4, 4],
               legend='Adj. opening price')
    ...
    if 'adjclosingprice' in request.form:
        p.line(data_lastmonth['Date'], data_lastmonth['Adj. Close'], line_color='red', line_dash=[4, 4],
               legend='Adj. closing price')
